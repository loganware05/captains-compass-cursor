...
| Skill | Score | Notes |
|---|---:|---|
| `testing-validation` | 0.525 | capability_overlap=0.225 |
| `react-engineering` | 0.4688 | capability_overlap=0.1688 |
| `accessibility-review` | 0.3563 | lifecycle_stage=0.15 |
...
Machine artifact: `.agent/plans/release-v1.5.0-smoke/task-graph.json`
...
| `task-impl-frontend` | `implementation-agent` | coding-strong | `react-engineering`, `autonomy-budget`, `code-structure-cleanup` | Task 'task-impl-frontend' requires [react-component-development, typescript-ui, component-testing]. Reference profile 'implementation-agent' with model class 'coding-strong'. Selected Skills: [react-engineering, autonomy-budget, code-structure-cleanup]. |
...
Machine artifact: `.agent/plans/release-v1.5.0-smoke/manifests.json`
...
Retain under `.agent/plans/release-v1.5.0-smoke/`:

- .agent/plans/release-v1.5.0-smoke/resolve.json
- .agent/plans/release-v1.5.0-smoke/task-graph.json
- .agent/plans/release-v1.5.0-smoke/manifests.json
