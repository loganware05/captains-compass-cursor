...
| 3 | **B4 — Repair loop** — FIND→PROVE→FIX→TEST→SUBMIT | **IMPLEMENTING** | [OVA-48](https://linear.app/ovaltechnologysolutions/issue/OVA-48); [issue #154](https://github.com/loganware05/captains-compass-cursor/issues/154); branch `cursor/m32-b4-repair-loop-3b10` |

## Authority

- GitHub/repo evidence canonical; Linear records only
- `approved_for_execution` remains **false**
- B4 Captain-approved; hermetic dry-run default; never auto-merge
