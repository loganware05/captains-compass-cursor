...
usage() {
  cat <<'USAGE'
Usage: query-technology-intelligence.sh --query TEXT [--top N] [--provider stub|file|github-stars|github-stars-cached|github-stars-categorized|huggingface-file|huggingface-hub|package-registry-file|package-registry]
...
huggingface-file reads offline HF model-card fixtures; huggingface-hub queries live Hub.
USAGE
}
