> Durable plan archive for `m41-jev-decision-service` (v1.42.0). Merged via #179.
...
| Field | Value |
|---|---|
| Status | **COMPLETE** — merged via [#179](https://github.com/loganware05/captains-compass-cursor/pull/179), tagged **v1.42.0** |
