...
- M1 Phase G: tests, evals, doctor hardening ([#35](https://github.com/loganware05/captains-compass-cursor/issues/35))
- PR [#36](https://github.com/loganware05/captains-compass-cursor/pull/36) — Phases A–F

## Next

- Phase G fixture/eval expansion
- Phase H provider doc finalization (stub shipped in F)
