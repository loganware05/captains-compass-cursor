...
assert_true "northstar-connected-routine skill in control" test -f "$ROOT/.cursor/skills/northstar-connected-routine/SKILL.md"
...
assert_true "run-northstar-routine script in control" test -f "$ROOT/scripts/run-northstar-routine.sh"
assert_true "reconcile-northstar-run script in control" test -f "$ROOT/scripts/reconcile-northstar-run.sh"
